    ...
    exports.BookEditView = Marionette.ItemView.extend({
      ...
      onRender: function() {
        ...
        return Aloha.ready(function() {
          var model;
          model = _this.model;
          _EnableContentDragging(_this.$el.find('.organization-node,*[data-media-type]'));
