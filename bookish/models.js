...
(function() {
  ...
  define(['exports', 'jquery', 'backbone', 'bookish/media-types', 'i18n!bookish/nls/strings'], function(exports, jQuery, Backbone, MEDIA_TYPES, __) {
    var ALL_CONTENT, AllContent, BaseBook, BaseContent, BaseModel, BookTocNode, BookTocNodeCollection, BookTocTree, CONTENT_COMPARATOR, Config, Deferrable, DeferrableCollection, FilteredCollection, Folder, WorkspaceTree;
    ...
    Config = Backbone.Model.extend({
      defaults: {
        ...
        metadataSubjects: ['Arts', 'Mathematics and Statistics', 'Business', 'Science and Technology', 'Humanities', 'Social Sciences']
      }
    });
