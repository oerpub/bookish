...
(function() {
  ...
  define('epub-local', ['jquery', 'backbone', 'bookish/controller', 'bookish/models', 'epub/models', 'css!bookish'], function(jQuery, Backbone, BookishController, BookishModels, Models) {
