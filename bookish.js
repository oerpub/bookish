...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'marionette', 'aloha', 'bookish/auth', 'bookish/controller', 'css!bookish'], function(jQuery, _, Backbone, Marionette, Aloha, Auth, Controller) {
    Controller.start();
